...
public class QueenManager implements Listener {
    ...
    TWAbility[] itemsList = {new WitherBow(), new MagicMirror(), new Scaffolding(), new TNTBundle(), new GoldPickaxe(),new PoisonShank(),new RevivalTotem(plugin),new PortalShutdownItem(plugin), new SlowingBomb(), new ObsidianItem(), new StoneItem(), new WoodItem(), new IronBlockItem()};
